...
# The goal or purpose EDA is to develop an understanding of our data.
# EDA Topics:
# Structure
# Quality
# Variability
# Co-variability
# Important and interesting relationships
...
# 2. List variables on each year-specific data frame
names(df)

# 3. Display data summary and statistics
str(df)
summary(df)
dim(df)
head(df, 10)
